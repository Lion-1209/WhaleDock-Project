#pragma once
// ============================================================
// 服务层 · TLS 根证书（GitHub API / Release 下载共用）
// 2026-09 实测 GitHub 链：*.github.com <- Sectigo E36 <- Sectigo E46
// （E46 上游 USERTrust ECC）。信任锚：USERTrust ECC + Sectigo E46；
// 另备 DigiCert G2 / USERTrust RSA 应对轮换。证书轮换需发新固件；
// TLS 拦截型网络下直连校验失败属预期，应改用 https 中转前缀。
// ============================================================

constexpr const char* kGithubRoots =
"-----BEGIN CERTIFICATE-----\n"
